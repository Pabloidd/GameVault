          ...
          {#each tableStore.data as row}
            <tr>
              ...
              <td class="actions-cell">
                ...
                {/if}
                {#if tableStore.currentTableId === 'genres' || tableStore.currentTableId === 'publishers'}
                  <button class="action-btn games" onclick={() => tableStore.openModal('gamesByRelation', row)} title="Просмотреть игры">
